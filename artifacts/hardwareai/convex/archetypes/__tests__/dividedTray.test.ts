...
describe("dividedTray", () => {
  ...
  it("generates 5 parts and 4 weld_seam interfaces with 0 dividers", () => {
    // Wall-to-base joints are weld_seam — see comment in dividedTray.ts.
  ...
  it("generates 8 parts and 10 weld_seam interfaces with 3 dividers", () => {
